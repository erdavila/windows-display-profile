...
pub use windows::Win32::Devices::Display::{
    ...
    DISPLAYCONFIG_PIXELFORMAT, DISPLAYCONFIG_PIXELFORMAT_8BPP, DISPLAYCONFIG_PIXELFORMAT_16BPP,
    DISPLAYCONFIG_PIXELFORMAT_24BPP, DISPLAYCONFIG_PIXELFORMAT_32BPP,
    DISPLAYCONFIG_PIXELFORMAT_NONGDI, DISPLAYCONFIG_RATIONAL, DISPLAYCONFIG_ROTATION,
    DISPLAYCONFIG_ROTATION_IDENTITY, DISPLAYCONFIG_ROTATION_ROTATE90,
    ...
    DISPLAYCONFIG_VIDEO_SIGNAL_INFO, DisplayConfigGetDeviceInfo, GetDisplayConfigBufferSizes,
    QDC_ALL_PATHS, QDC_ONLY_ACTIVE_PATHS, QDC_VIRTUAL_MODE_AWARE, QUERY_DISPLAY_CONFIG_FLAGS,
...
pub use windows::Win32::Foundation::{
    ...
    ERROR_NOT_SUPPORTED, ERROR_SUCCESS, LUID, POINTL, RECTL, WIN32_ERROR,
};
